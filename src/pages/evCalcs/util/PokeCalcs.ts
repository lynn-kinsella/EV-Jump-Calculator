...
import { SelectedPokemonInterface } from "./SelectedPokemon";

// Clamp EVs between 0 and 255, and prevent the total EVs for the pokemon
// from exceeding 510
export function validateEVs(refPkmn: SelectedPokemonInterface, stat: StatID, value: number): number {
    ...
    // Round down to nearest jump number
    value = (Math.floor((value - 4) / 8)) * 8 + 4
